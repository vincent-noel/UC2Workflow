...
# # DEBUG
# setwd("~/Cancer_sysbio/+ PerMedCoE/resultats/Use case 5 workflow and building blocks/pilot_workflow")
#opt <- list()
# opt$meta_file = "~/projects/data/single_cell_datasets/GSE145926_covid19/metadata.tsv"
#opt$meta_file = "./data/metadata_small.tsv"
#opt$outdir <- "results2"
#opt$verbose <- F
# i=1
